...
module.exports = (env, argv) => {
	...
	const projectConfig = {
		config: {
			...
			projectUrl: 'dev.infinum.test', // Used for providing browsersync functionality.
			projectPath: 'wp-content/themes/infinum-wordpress-task', // Project path relative to project root.
		},
	};
